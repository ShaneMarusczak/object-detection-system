...
Maps COCO class IDs to human-readable names.
Used by the processor for event enrichment.

NOTE: This belongs in the processor, not the edge detector.
The Jetson sends class IDs only; the processor enriches with names.
"""

# COCO class ID to name mapping (80 classes)
COCO_CLASSES = {
    0: 'person',
    1: 'bicycle',
    2: 'car',
